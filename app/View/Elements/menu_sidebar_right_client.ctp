  ...
  <div class="nav-side-menu" style="margin-left: 10px;">
    ...
    <div style="background-color:#fff;padding-left:10px;padding-right:10px;">
           ...
           <li  data-toggle="collapse" data-target="#products" class="collapsed active">
              ...
              <li>
                <a href="#">
                  <i style="color:#2DB4DB" class="fa fa-cogs  fa-lg"></i><span> <?php echo $this->Html->link( 'ព៍តមានទូទៅ',array('controller'=>'Clients','action'=>'view_setting', $id),array('escape' => 0));?></span> 
                </a>
              </li>
