          ...
          <div class="col-md-3">
              <div style="background:#E0EEF2;" class="panel-heading bg-white border-none">
                <div class="col-md-12 col-sm-6 col-xs-6 text-center padding-0">
                 ...
                 <br>
                  <h4  class="text-center">Sponsor</h4>
                   ...
                   <!-- Steps Circular Progress - START -->
                        ...
                        <div id="progress5" class="col-xs-12 col-md-4 col-lg-4" style="width: 100px; height: 100px; top: -17px;position: absolute;margin-left: 30px;">
                          ...
                          var progress = $("#progress5").shieldProgressBar({
                              ...
                              text: {
                                  enabled: true,
                                  template: '<span style="position:absolute;left: 40px;font-weight: bold;top: 39px;absolute;font-size:15px; color: #1E98E4">{0}%</span>'
                              },
                          }).swidget();
          ...
          <div class="col-md-3">
              <div style="background:#E0EEF2;" class="panel-heading bg-white border-none">
                <div class="col-md-12 col-sm-6 col-xs-6 text-center padding-0">
                 <!--  <i style="color:#2DB4DB" class="fa fa-3x  fa-university" aria-hidden="true" > </i> -->
                 <br>
                  <h4  class="text-center">Second Level</h4>
